...
for(i in unique(SoCal_fishing_blocks_pelagic_2004$year)){
  x<-ggplot()+
    ...
    geom_sf(data= subset(SoCal_fishing_blocks_pelagic_2004, year==i & year<2004), aes(fill=CPUE))+
...
for(i in unique(SoCal_fishing_blocks_pelagic_2004$year)){
  x<-ggplot()+
    geom_sf(data=SoCal_fishing_blocks, fill="white")+
    geom_sf(data= subset(SoCal_fishing_blocks_pelagic_2004, year==i & year<2004), aes(fill=proportional_catch))+
    scale_fill_gradientn(colours=rev(magma(6)),
