...
```{r}
pelagicsmpa_species_block_year<-aggregate(CPFV_pelagics_mpa$n_kept, by=list(year=CPFV_pelagics_mpa$year, block_id=CPFV_pelagics_mpa$block_id, species=CPFV_pelagics_mpa$species_name), FUN=sum)
pelagicsmpa_species_block_year<-rename(pelagicsmpa_species_block_year, "total"= "x")
pelagicsmpa_species_block_year$year<-as.factor(pelagicsmpa_species_block_year$year)
...
ggplot(pelagicsmpa_species_block_year, aes(year, total, fill=species))+ 
  ...
  geom_vline(xintercept=which(pelagicsmpa_species_block_year$year == "2004"), colour="black", size=1)+
  geom_vline(xintercept=which(pelagicsmpa_species_block_year$year == "2007"), colour="black", size=1)
  geom_vline(xintercept=which(CPFV_pelagics_mpa$year == '1982'), colour="black", size=1, linetype=3)+
  geom_vline(xintercept=which(CPFV_pelagics_mpa$year == '1991'), colour="black", size=1, linetype=3)+
  geom_vline(xintercept=which(CPFV_pelagics_mpa$year == '1986'), colour="black", size=1, linetype=3)+
  geom_vline(xintercept=which(CPFV_pelagics_mpa$year == '1997'), colour="black", size=1, linetype=3)
...
#### Create dataframe summed by species, year, and block
```{r}
pelagicssocal_species_block_year<-aggregate(CPFV_pelagics_socal$n_kept, by=list(year=CPFV_pelagics_socal$year, block_id=CPFV_pelagics_socal$block_id, species=CPFV_pelagics_socal$species_name), FUN=sum)
...
####**Graphing total trend by species and year
```{r}
ggplot(pelagicssocal_species_block_year, aes(year, total, fill=species))+ 
  #geom_point()+
  geom_col()+
  #facet_wrap(~species)+
  theme_bw()+
