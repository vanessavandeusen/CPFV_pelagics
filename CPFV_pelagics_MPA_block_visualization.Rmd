...
plot3<-ggplot()+ 
  ...
  theme_classic()+
  annotation_scale(location= "tl", pad_y = unit(0.1, "cm"), pad_x = unit(0.7, "cm"))+
...
for(i in unique(MPA_fishing_blocks_pelagic_2004$year)){
  x<-ggplot()+
    ...
    annotation_north_arrow(location= "tr", which_north= "true", width= unit(1, "cm"),  height= unit(1, "cm"),style= north_arrow_fancy_orienteering(), pad_x = unit(0.5, "cm"), pad_y = unit(0.1, "cm"))+
    xlab("Longitude")+
    ylab("Latitude")+
